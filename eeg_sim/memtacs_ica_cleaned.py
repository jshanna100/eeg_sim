...
print("Completed in {:.1f}".format(perf_counter()-begin))

df = pd.DataFrame.from_dict(df_dict)
df.to_pickle("{}comp_vecs_{}_cleaned.pickle".format(proc_dir, clean_type))
sources = np.array(sources, dtype=object)
np.save("{}comp_sources_{}_cleaned.npy".format(proc_dir, clean_type), sources)
